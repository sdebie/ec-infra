...
(
    ...
    attributes     TEXT, -- Stores {"color": "Red", "size": "XL"}
...
(
    ...
    price_start_date TIMESTAMPTZ,
    price_end_date   TIMESTAMPTZ,
    created_at       TIMESTAMPTZ      DEFAULT CURRENT_TIMESTAMP,
    created_by       UUID,
...
(
    ...
    additional_info JSON        NOT NULL DEFAULT '{}',
...
(
    ...
    address_type   VARCHAR(255), -- 'PHYSICAL', 'POSTAL', 'BILLING', 'SHIPPING'
...
(
    ...
    reg_number         VARCHAR(255),            -- CIPC Registration
...
(
    ...
    finance_contact_phone   VARCHAR(13),
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_wholesale_applications_account_email_partial
    ON wholesale_applications (account_email)
...
(
    ...
    country_code       VARCHAR(2) NOT NULL, -- 'ZA', 'US'
...
(
    ...
    raw_response       TEXT,           -- Stores the unique JSON body from EACH gateway
...
(
    ...
    items_lastupdate TIMESTAMPTZ      DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    created_at        TIMESTAMPTZ      DEFAULT CURRENT_TIMESTAMP, --"Created": "2026-08-03T17:49:05.087"
    updated_at        TIMESTAMPTZ      DEFAULT CURRENT_TIMESTAMP, --"Modified": "2026-08-05T09:20:02.317"
...
(
    ...
    quoted_notes      TEXT,
    quoted_by         UUID         REFERENCES staff_users (id) ON DELETE SET NULL
);
