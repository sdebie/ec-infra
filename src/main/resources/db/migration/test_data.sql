...
('16862af0-3943-4055-9164-95f88e5155e4', 'ESP32-C3-PIN', 95.00, 25, '{"headers": "Soldered"}', 0.02),
('16862af0-3943-4055-9164-95f88e5155e4', 'ESP32-C3-NO-PIN', 85.00, 50, '{"headers": "None"}', 0.01),

-- Arduino Nano (Simple product, usually 1 variant)
('26862af0-3943-4055-9164-95f88e5155e4', 'ARD-NANO-R3', 110.00, 15, NULL, 0.05),

-- LED Strip Variants (Warm White vs Cool White)
('36862af0-3943-4055-9164-95f88e5155e4', 'COB-5M-WW', 350.00, 10, '{"color_temp": "3000K", "color": "Warm White"}', 0.20),
('36862af0-3943-4055-9164-95f88e5155e4', 'COB-5M-CW', 350.00, 12, '{"color_temp": "6000K", "color": "Cool White"}', 0.20),

-- Power Supply
('46862af0-3943-4055-9164-95f88e5155e4', 'PSU-12V-60W', 220.00, 8, NULL, 0.45),

-- White Variants
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-WHT-S', 250.00, 10, '{"color": "White", "size": "S"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-WHT-M', 250.00, 15, '{"color": "White", "size": "M"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-WHT-L', 250.00, 12, '{"color": "White", "size": "L"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-WHT-XL', 275.00, 5,  '{"color": "White", "size": "XL"}', 0.02),

-- Black Variants
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-BLK-S', 250.00, 8,  '{"color": "Black", "size": "S"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-BLK-M', 250.00, 20, '{"color": "Black", "size": "M"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-BLK-L', 250.00, 18, '{"color": "Black", "size": "L"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-BLK-XL', 275.00, 7,  '{"color": "Black", "size": "XL"}', 0.02),

-- Navy Variants
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-NVY-S', 250.00, 5,  '{"color": "Navy", "size": "S"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-NVY-M', 250.00, 12, '{"color": "Navy", "size": "M"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-NVY-L', 250.00, 10, '{"color": "Navy", "size": "L"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-NVY-XL', 275.00, 3,  '{"color": "Navy", "size": "XL"}', 0.02),

-- Olive Variants
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-OLV-S', 250.00, 6,  '{"color": "Olive", "size": "S"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-OLV-M', 250.00, 10, '{"color": "Olive", "size": "M"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-OLV-L', 250.00, 9,  '{"color": "Olive", "size": "L"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-OLV-XL', 275.00, 4,  '{"color": "Olive", "size": "XL"}', 0.02),

-- Maroon Variants
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-MRN-S', 250.00, 4,  '{"color": "Maroon", "size": "S"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-MRN-M', 250.00, 8,  '{"color": "Maroon", "size": "M"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-MRN-L', 250.00, 11, '{"color": "Maroon", "size": "L"}', 0.02),
('56862af0-3943-4055-9164-95f88e5155e4', 'UT-TEE-MRN-XL', 275.00, 2,  '{"color": "Maroon", "size": "XL"}', 0.02);
